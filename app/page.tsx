...
const TILES: Tile[] = [
  ...
  },
  {
    ...
    word1: "Design",
    word2: "sandbox",
    desc: "AI-assistant motion lab — every FAB variant side by side, including the new orbit × sparkles merge.",
    count: "7 variants",
    badge: { tone: "live", label: "Live" },
    href: "/sandbox",
  },
  {
    ...
    word1: "UI",
    word2: "kit",
    desc: "The design system — color / spacing / type / motion tokens + component primitives with every state.",
    count: "Tokens + components",
    badge: { tone: "live", label: "Live" },
    href: "/uikit",
  },
];
