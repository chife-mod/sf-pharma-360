...
> **Статус (2026-05-31):** инициация. Папка создана, скриншоты живой
> production-версии и Figma-референсы собраны. Стек согласован с
> пользователем ниже (см. **Stack**). Next.js проект ещё не поднят —
> следующий шаг.
