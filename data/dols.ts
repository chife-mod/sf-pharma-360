/* Pharma 360 — DOL dataset (plausible, fictional).
 * Domain: bariatric / obesity-surgery KOLs across MENA + intl.
 * Real names sourced from pharma.market360.ai/influencers; KPI
 * values synthetic. Single source of truth for the /dols surface.
 */
